...
class ModbusMaster
{
  public:
    ...
    */
    ...
    uint8_t requestFrom(uint8_t, uint16_t, uint16_t);
    void sendBit(bool);
    void send(uint8_t);
    void send(uint16_t);
    void send(uint32_t);
    ...
    long int  RS485_Communication(uint8_t, uint16_t);
    long int  Set_Speed(uint8_t, uint16_t);
    long int  Run_Motor(uint8_t, uint16_t);
    long int  Motor_Stop(uint8_t, uint16_t);
    long int  Motor_Brake(uint8_t, uint16_t);
    long int  Speed_Feedback(uint8_t);
    long int  Current_Feedback(uint8_t);
    long int  Voltage_Feedback(uint8_t);
